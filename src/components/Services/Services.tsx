    ...
    return (
        <Transition className="grid px-4 py-8 md:py-46 md:px-36 md:grid-cols-2 md:gap-28">
            <div className="max-w-xl mb-7">
                ...
                <p className="mb-10 mt-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere, maiores voluptates aliquid eveniet fuga recusandae perferendis magnam. Ullam animi culpa velit optio, consequatur ratione nulla, magni, id totam eum odio.</p>
            </div>
